...
require('views/common/modal_popups/manage_oidc_credentials_popup');
...
require('views/common/form/manage_oidc_credentials_form_view');
...
require('views/main/admin/highAvailability/kudu/addMaster/wizard_view');
require('views/main/admin/highAvailability/kudu/addMaster/step1_view');
require('views/main/admin/highAvailability/kudu/addMaster/step2_view');
require('views/main/admin/highAvailability/kudu/addMaster/step3_view');
require('views/main/admin/highAvailability/kudu/addMaster/step4_view');
