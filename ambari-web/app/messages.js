...
Em.I18n.translations = {
  ...
  'requestInfo.oidcService': 'Install OIDC Service',
  ...
  'admin.oidc.credentials.category': 'OIDC Admin',
  'admin.oidc.credentials.principal.label': 'OIDC Admin Username',
  'admin.oidc.credentials.password.label': 'OIDC Admin Password',
  'admin.oidc.credentials.store.menu.label': 'Manage OIDC Credentials',
  'admin.oidc.credentials.form.header.stored': 'Update or remove the stored OIDC admin credentials in the encrypted credential store.',
  'admin.oidc.credentials.form.header.not.stored': 'Specify the OIDC admin credentials to remember in the encrypted credential store.',
  'admin.oidc.credentials.remove.confirmation.body': 'You are about to remove the OIDC admin credentials from Ambari. Are you sure?',
  'admin.oidc.button.enableSecurity': 'Enable Security',
  'admin.oidc.button.manageCredentials': 'Manage OIDC Credentials',
  'admin.oidc.button.runProvisioning': 'Run OIDC Provisioning',
  'admin.oidc.provisioning.request.accepted': 'OIDC provisioning request has been submitted.',
  'admin.oidc.clients.title': 'OIDC Clients',
  'admin.oidc.clients.table.service': 'Service',
  'admin.oidc.clients.table.clientName': 'Client Name',
  'admin.oidc.clients.table.clientId': 'Client ID',
  'admin.oidc.clients.table.realm': 'Realm',
  'admin.oidc.clients.table.enabled': 'Enabled',
  'admin.oidc.clients.table.mappers': 'Protocol Mappers',
  'admin.oidc.clients.table.viewMappers': 'View',
  'admin.oidc.clients.noClients': 'No OIDC clients defined for installed services.',
  'admin.oidc.clients.mappers.title': 'Protocol Mappers — {0}',
  'admin.oidc.clients.mappers.name': 'Name',
  'admin.oidc.clients.mappers.protocol': 'Protocol',
  'admin.oidc.clients.mappers.type': 'Mapper Type',
  'admin.oidc.clients.mappers.config': 'Configuration',
  'admin.oidc.button.enableOidc': 'Enable OIDC',
  'admin.oidc.provisioning.popup.restart.body': 'After OIDC provisioning completes, affected services may need to be restarted to pick up new OIDC configuration.',
  'admin.oidc.provisioning.popup.restart.checkbox': 'Restart affected services after provisioning completes',
  'admin.oidc.wizard.header': 'Enable OIDC Wizard',
  'admin.oidc.wizard.step1.header': 'Get Started',
  'admin.oidc.wizard.step1.description': 'This wizard will configure Ambari to provision OIDC clients in your Keycloak server and enable single sign-on for your cluster services.',
  'admin.oidc.wizard.step1.oidcServiceInstalled': 'OIDC service is installed on this cluster.',
  'admin.oidc.wizard.step1.oidcServiceNotInstalled': 'The OIDC service is not installed on this cluster. You can still configure Keycloak settings, but OIDC provisioning will not run until the OIDC service is added via Services > Add Service.',
  'admin.oidc.wizard.step1.whatWizardDoes': 'The wizard will:',
  'admin.oidc.wizard.step1.point1': 'Configure the Keycloak connection settings (admin URL, realm, credentials).',
  'admin.oidc.wizard.step1.point2': 'Optionally test connectivity to your Keycloak server.',
  'admin.oidc.wizard.step1.point3': 'Register OIDC clients for installed services that declare an oidc.json descriptor.',
  'admin.oidc.wizard.step2.header': 'Configure Keycloak',
  'admin.oidc.wizard.step2.description': 'Enter your Keycloak connection details. Fields marked * are required.',
  'admin.oidc.wizard.step2.adminUrl': 'Keycloak Admin URL',
  'admin.oidc.wizard.step2.adminRealm': 'Admin Realm',
  'admin.oidc.wizard.step2.adminClientId': 'Admin Client ID',
  'admin.oidc.wizard.step2.adminClientSecret': 'Admin Client Secret',
  'admin.oidc.wizard.step2.realm': 'Target Realm',
  'admin.oidc.wizard.step2.issuerUrl': 'Issuer URL',
  'admin.oidc.wizard.step2.adminUsername': 'Admin Username',
  'admin.oidc.wizard.step2.adminPassword': 'Admin Password',
  'admin.oidc.wizard.step2.verifyTls': 'Verify TLS Certificate',
  'admin.oidc.wizard.step2.testConnectionBtn': 'Test Connection',
  'admin.oidc.wizard.step2.testError': 'Connection test failed. Check your settings.',
  'admin.oidc.wizard.step3.header': 'Review & Enable',
  'admin.oidc.wizard.step3.description': 'Review your Keycloak configuration. Click Enable to save settings, store credentials, and trigger OIDC provisioning.',
  'admin.oidc.wizard.step3.restartAfter': 'Restart affected services after provisioning completes',
  'admin.oidc.wizard.step3.enableBtn': 'Enable OIDC',
  'admin.oidc.wizard.step3.oidcNotInstalledError': 'OIDC service is not installed. Please add the OIDC service via Services > Add Service before enabling OIDC.',
  'admin.oidc.button.disableOidc': 'Disable OIDC',
  'admin.oidc.button.rotateSecrets': 'Rotate Secrets',
  'admin.oidc.disable.header': 'Disable OIDC',
  'admin.oidc.disable.description': 'This operation stops all affected services, removes provisioned OIDC clients from the external provider, and restarts services.',
  'admin.oidc.disable.confirmation.header': 'Disable OIDC',
  'admin.oidc.disable.confirmation.body': 'This will stop all services, delete all provisioned OIDC clients from Keycloak, and restart services. OIDC single sign-on will no longer function. Are you sure?',
  'admin.oidc.disable.onClose': 'OIDC un-provisioning is in progress. Closing will leave OIDC in a partially disabled state. Are you sure you want to exit?',
  'admin.oidc.disable.inProgress.header': 'Un-provisioning In Progress',
  'admin.oidc.disable.inProgress.message': 'OIDC client deletion is currently in progress and cannot be interrupted. Please wait for it to complete.',
  'admin.oidc.disable.step1.task1.title': 'Stop All Services',
  'admin.oidc.disable.step1.task2.title': 'Delete OIDC Clients',
  'admin.oidc.disable.step1.task3.title': 'Start All Services',
  'admin.oidc.disable.notice.completed': 'OIDC clients have been removed and all services have been restarted.',
  'admin.oidc.disable.inProgress': 'OIDC un-provisioning is in progress. Please wait...',
  'admin.oidc.rotate.popup.header': 'Rotate OIDC Client Secrets',
  'admin.oidc.rotate.popup.body': 'This will regenerate client secrets for all provisioned OIDC clients and update the Ambari credential store. Affected services may need to be restarted.',
  ...
  'admin.kerberos.wizard.step1.security.switches.header': 'Security Scope',
  'admin.kerberos.wizard.step1.security.switch.enableKerberos': 'Enable Kerberos',
  'admin.kerberos.wizard.step1.security.switch.configureOidc': 'Configure OIDC',
  'admin.kerberos.wizard.step1.security.switch.configureOidc.unavailable': 'OIDC service is not available in this stack.',
