...
class DataCleaner(threading.Thread):
  COMMAND_FILE_NAMES_PATTERN = r'errors-\d+.txt|output-\d+.txt|site-\d+.pp|structured-out-\d+.json|command-\d+.json'
  AUTO_COMMAND_FILE_NAMES_PATTERN = \
    r'auto_command-\d+.json|auto_errors-\d+.txt|auto_output-\d+.txt|auto_structured-out-\d+.json'
