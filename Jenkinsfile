pipeline {
    ...
    stages {
        ...
        stage('Clone Repo') {
            steps {
                git branch: 'master', credentialsId: 'lucasbak', url: 'https://gitlab.luc-data.com/odp/bigtop.git'
        ...
        withEnv([]){
            try {
                ...
                stage('Copy Ambari RPM') {
                    ...
                    // git branch: "branch-${ZOOKEEPER_VERSION}", credentialsId: 'lucasbak', url: 'https://gitlab.luc-data.com/odp/zookeeper-release-odp.git'
