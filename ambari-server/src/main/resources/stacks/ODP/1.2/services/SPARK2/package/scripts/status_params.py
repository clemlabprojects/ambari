...
if "spark2-livy2-env" in config['configurations']:
  livy2_user = config['configurations']['spark2-livy2-env']['livy2_user']
  livy2_group = config['configurations']['spark2-livy2-env']['livy2_group']
  livy2_pid_dir = config['configurations']['spark2-livy2-env']['livy2_pid_dir']
