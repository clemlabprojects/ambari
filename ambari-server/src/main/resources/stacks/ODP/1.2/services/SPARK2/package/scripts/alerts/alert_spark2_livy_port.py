...
LIVY_SERVER_HOST_KEY = '{{spark2-livy2-conf/livy.server.host}}'

LIVY_SERVER_PORT_KEY = '{{spark2-livy2-conf/livy.server.port}}'
...
LIVY_SSL_ENABLED_KEY = '{{spark2-livy2-conf/livy.keystore}}'
