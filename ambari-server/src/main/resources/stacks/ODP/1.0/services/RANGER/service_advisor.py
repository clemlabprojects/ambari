...
class RangerRecommender(service_advisor.ServiceAdvisor):
  ...
  def recommendRangerConfigurationsFromHDP23(self, configurations, clusterData, services, hosts):
    ...
    ranger_services = [
      ...
      {'service_name': 'KUDU', 'audit_file': 'ranger-kudu-audit'},
    ...
    required_services = [
      ...
      {'service_name': 'KUDU', 'config_type': 'ranger-kudu-security'},
      ...
      {'service_name': 'NIFI','config_type': 'ranger-nifi-security'},
      {'service_name': 'NIFI_REGISTRY','config_type': 'ranger-nifi-registry-security'}
    ]
  ...
  def recommendRangerConfigurationsFromHDP25(self, configurations, clusterData, services, hosts):
    ...
    ranger_plugins_serviceuser = [
      ...
      {'service_name': 'NIFI_REGISTRY', 'file_name': 'nifi-registry-env', 'config_name': 'nifi_registry_user', 'target_configname': 'ranger.plugins.nifi-registry.serviceuser'}
    ]
