...
def setup_ranger_atlas(upgrade_type=None):
  ...
  if params.enable_ranger_atlas:
    ...
    if params.ranger_kafka_plugin_enabled:
      ...
      # Ranger Tag Sync
      if params.has_ranger_tagsync:
        ranger_admin_v2_obj.create_policy_user(params.ranger_admin_username, params.ranger_admin_password, params.rangertagsync_user)
