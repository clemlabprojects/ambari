...
def setup_ranger_impala(upgrade_type = None):
    ...
    if params.enable_ranger and params.enable_ranger_hive:
        ...
        setup_ranger_plugin('hive-server2', 'hive', params.ranger_previous_jdbc_jar,
                            ...
                            params.enable_ranger, conf_dict=params.hive_conf_dir,
                            component_user=params.hive_user, component_group=params.user_group, cache_service_list=params.cache_service_list,
                            ...
                            component_user_keytab=params.hive_keytab if params.security_enabled else None)
    else:
