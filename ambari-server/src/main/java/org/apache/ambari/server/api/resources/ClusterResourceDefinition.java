...
public class ClusterResourceDefinition extends BaseResourceDefinition {
  ...
  public Collection<String> getUpdateDirectives() {
    ...
    directives.add(KerberosHelper.DIRECTIVE_CONFIGURE_OIDC);
    directives.add(KerberosHelper.DIRECTIVE_CONFIGURE_OIDC_ONLY);
    directives.add(KerberosHelper.DIRECTIVE_OIDC_OPERATION);
