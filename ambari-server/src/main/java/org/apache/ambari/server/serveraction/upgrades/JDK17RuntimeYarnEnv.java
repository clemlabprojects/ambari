...
//
public class JDK17RuntimeYarnEnv extends AbstractUpgradeServerAction{

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(JDK17RuntimeYarnEnv.class);

    private static final String CONTENT_PROPERTY_NAME = "content";
    private static final String TARGET_CONFIG_TYPE = "yarn-env";
