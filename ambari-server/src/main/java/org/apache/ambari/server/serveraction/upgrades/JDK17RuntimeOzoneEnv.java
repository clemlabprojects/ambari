...
public class JDK17RuntimeOzoneEnv extends AbstractUpgradeServerAction{
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(JDK17RuntimeOzoneEnv.class);

    private static final String CONTENT_PROPERTY_NAME = "content";
    private static final String TARGET_CONFIG_TYPE = "ozone-env";
    private static final String SERVICE_NAME = "OZONE";
    @Inject
