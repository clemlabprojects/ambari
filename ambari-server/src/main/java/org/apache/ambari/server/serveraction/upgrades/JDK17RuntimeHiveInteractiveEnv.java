...
//
public class JDK17RuntimeHiveInteractiveEnv extends AbstractUpgradeServerAction{

    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(JDK17RuntimeHiveInteractiveEnv.class);

    private static final String CONTENT_PROPERTY_NAME = "content";
    private static final String TARGET_CONFIG_TYPE = "hive-interactive-env";
