...
/**
 * Placeholder for Auth0 OIDC provider support.
 * <p>
 * All operations throw {@link OidcOperationException} until a full implementation is provided.
 * </p>
 */
public class Auth0OidcOperationHandler implements OidcOperationHandler {

  private static final String NOT_SUPPORTED =
      "Auth0 OIDC provider is not yet supported. Contribute an implementation via the Ambari community.";
