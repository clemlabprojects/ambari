...
public interface OidcOperationHandler extends AutoCloseable {
  void open(PrincipalKeyCredential administratorCredential, OidcProviderConfiguration configuration) throws OidcOperationException;
