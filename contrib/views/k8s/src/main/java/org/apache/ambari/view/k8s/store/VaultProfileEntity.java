...
/**
 * Persistent entity to store a single Vault profile.
 */
@Entity
@Table(name = "k8s_vault_profile")
public class VaultProfileEntity extends BaseModel {
     ...
     */
    public static void upsert(DataStore ds, VaultProfileEntity e) throws PersistenceException {
        ds.store(e);
    }
}
